...
local color_white = {9, 8, 8}

local color_blue = {214, 214, 214}
...
function CMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
	...
	local tableColor, add, currentMenuData = boolSelected and (button.colorSelected or {  204, 210, 207, 150 }) or (button.colorFree or { 0, 0, 0, 100 }), .0, self.Menu[self.Data.currentMenu]

	DrawRect(intX, intY, intW, intH, tableColor[1], tableColor[2], tableColor[3], tableColor[4])

	tableColor = boolSelected and {39, 255, 0} or {184, 210, 0}
--{191, 174, 5} or {255, 255, 255}
